...
def main():
  ...
  st.sidebar.markdown(" ")
  st.sidebar.markdown("Final Assignment for the CSI 703 ")

  st.sidebar.markdown("**Author**: Mansoor Bari")
  st.sidebar.markdown("")
  ...
  st.markdown("*I have chosen the NYC Airbnb dataset from the begining of the semester")
